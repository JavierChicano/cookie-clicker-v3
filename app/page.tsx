...
export default function Home() {
  return (
    <main className="grid grid-cols-[minmax(300px,300px)_minmax(500px,1fr)_minmax(550px,700px)] gap-y-10 relative">
      {/* <div
        id="mostrarCandado"
        className="flex flex-col justify-center absolute  rounded-r-lg w-full h-36 text-center items-center z-10 col-span-2 "
      >
      ...
      {/* Display monedas */}
      <section className="flex items-center bg-brown border-r border-b border-solid p-8 ">
        <img
          src="@public/nivel 1/coin1.png"
          alt={"coin"}
          className="relative h-32 cursor-pointer active:scale-120"
        />

        <article
          id="informacionMoneda1"
          className="flex flex-col items-center justify-center bg-opacity-50 bg-black h-100 w-120 rounded-10 ml-20 text-white leading-7"
        >
