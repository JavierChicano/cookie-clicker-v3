...
export default function CajaVerInfo() {
  ...
  return (
    <div
      id="preguntas"
      className={cn(!pathName.includes("Olimpo")? "h-10 w-10 flex items-center justify-center ml-3 bg-secundario rounded-full cursor-pointer hover:bg-seleccion hover:shadow-black" : "hidden" )}
    >
